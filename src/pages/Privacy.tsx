...
export default function Privacy(){
  useEffect(()=> setPageMeta("Privacy Policy — AnkerPlay", "AnkerPlay Privacy Policy, DMCA and third-party content policy"),[])
  return (
      ...
      <div className="card p-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-white/50">Last updated: {new Date().toLocaleDateString("en-GB", { day:"2-digit", month:"long", year:"numeric" })} • AnkerPlay</p>
          </div>
        </div>

        <div className="prose prose-invert max-w-none mt-6 text-sm leading-relaxed text-white/70">
          <p>AnkerPlay (“we”, “us”, “our”) operates as a curated index of <b className="text-white">freeware, open-source, demo and legally distributable</b> PC games and software. We do not host pirated or unlicensed commercial content. This policy explains what we collect, how we use it, and how third-party owners can request removal.</p>
          ...
          <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 mt-2 text-amber-100">
            ...
            <p className="mt-1 text-amber-200/80">AnkerPlay only indexes content that is freeware, open-source, demo, or shared with distribution permission. If you are the <b>game/software owner or rights holder</b> and believe your content is listed without permission or you wish it removed for any reason, <b>contact us and we will remove it promptly — typically within 24–48 hours</b> — no dispute.</p>
          </div>
          ...
          <ol className="list-decimal pl-5 space-y-1">
            ...
            <li>Exact AnkerPlay URL(s) to remove (e.g. <code className="bg-white/10 px-1 rounded">/game/your-game</code>).</li>
          ...
          <p>AnkerPlay is not directed to children under 13. We do not knowingly collect data from children.</p>
          ...
          <ul className="list-disc pl-5">
            ...
            <li>Subject line: <code className="bg-white/10 px-1 rounded">AnkerPlay Takedown — [Game Title]</code></li>
          </ul>
        ...
        <div className="mt-8 flex gap-2">
          ...
          <a href="mailto:mdswampodsarkar007@gmail.com?subject=AnkerPlay%20Takedown%20Request" className="btn-ghost">Request Removal</a>
        </div>
      </div>
    </div>
  )
