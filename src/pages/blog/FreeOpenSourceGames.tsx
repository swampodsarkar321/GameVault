...
export default function FreeOpenSourceGames(){
  ...
  return (
    <div className="py-6 max-w-3xl mx-auto">
      ...
      <p className="text-sm text-white/40 mt-1">GameVault • open source • verified</p>
      <div className="prose prose-invert max-w-none mt-6 text-sm leading-relaxed text-white/70">
        <p><b className="text-white">Free open source games</b> are the safest way to get <b className="text-white">free PC games download</b> without piracy. GameVault lists only GPL/MIT titles with official mirrors.</p>
        ...
        <p>All are on <Link to="/games" className="text-violet-300">GameVault games</Link> with Trending and Top charts. See also <Link to="/blog/best-free-pc-games-2026" className="text-violet-300">Best Free PC Games 2026</Link>.</p>
      </div>
    </div>
  )
}
