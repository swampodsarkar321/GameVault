...
export default function Software(){
  ...
  const pageSize=12
  useEffect(()=>{ setPageMeta("Free Software Download – Freeware & Open-Source Tools","Browse free software download — freeware & open-source tools for Windows. Audacity, GIMP, Blender & more on AnkerPlay.", { canonical:"/software", keywords:"free software download, freeware tools, open source software download, free PC software"}); fetchSoftware().then(s=>{ setList(s); setLoading(false)}) },[])
